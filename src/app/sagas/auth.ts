...
export default function* authSagas() {
    yield takeLatest('LOGIN_EMAIL_REQUESTED', logInMail);
    ...
    yield takeLatest('RESET_PASSWORD_REQUESTED', sendPasswordReset);
    yield takeLatest('DELETE_AUTHL_REQUESTED', deleteAuth);
}